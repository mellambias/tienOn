...
const tabsContainerItems = this.shadow.querySelector(
    '.tabs-container-items ul'
);
const tabsContainerContent = this.shadow.querySelector(
...
for (let tab in this.formStructure.tabs) {
    ...
    for (let row in this.formStructure.tabsContent[tab].rows) {
        ...
        for (let field in this.formStructure.tabsContent[tab].rows[row]
            .formElements) {
            let formElement =
                this.formStructure.tabsContent[tab].rows[row].formElements[
                    field
                ];
                ...
                switch (formElement.type) {
                    ...
                    case 'file': {
                        if (
                            ...
                            const imageGallery = document.createElement(
                                'image-gallery-component'
                            );
